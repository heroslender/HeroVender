package com.heroslender.herovender.version;
...
public class NMSVersion implements Comparable<NMSVersion> {
    ...
    public static final NMSVersion V1_18_R2 = NMSVersion.fromString("v1_18_R2");

    public static final NMSVersion CURRENT = current();

    @NotNull
    public static NMSVersion fromString(@NotNull String string) {
    ...
    private static NMSVersion current() {
        ...
        if (split.length > 3) {
            return NMSVersion.fromString(split[3]);
        }
